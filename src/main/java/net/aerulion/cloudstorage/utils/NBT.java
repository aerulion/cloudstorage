...
public enum NBT {
    ...
    VALUE_GUI_TYPE_CLOUD_ACCESS_POINT("CLOUD_ACCESS_POINT"),
    VALUE_GUI_TYPE_CLOUD_INTERFACE("CLOUD_INTERFACE"),
    VALUE_GUI_TYPE_CLOUD_SHOP("CLOUD_SHOP"),
    VALUE_GUI_TYPE_UPGRADE("UPGRADE");
