...
public enum NBT {
    ...
    KEY_CLOUD_EXPORT_BUS_ASSOCIATED_SLOT_UUID("CLOUD_EXPORT_BUS_ASSOCIATED_SLOT"),
    KEY_CLOUD_EXPORT_BUS_OWNER_UUID("CLOUD_EXPORT_BUS_OWNER"),
    KEY_CLOUD_IMPORT_BUS_OWNER_UUID("CLOUD_IMPORT_BUS_OWNER"),
    KEY_CLOUD_INTERFACE_MODE("CLOUD_INTERFACE_MODE"),
    KEY_CLOUD_INTERFACE_OWNER_UUID("CLOUD_INTERFACE_OWNER"),
    KEY_CLOUD_STORAGE_BLOCK_TYPE("CLOUD_STORAGE_BLOCK_TYPE"),
