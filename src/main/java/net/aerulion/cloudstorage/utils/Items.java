...
public enum Items {
    ...
    GUI_BUTTON_INTERFACE_HOTBAR(ItemUtils.buildGuiButton(Material.STRUCTURE_VOID, Main.PRIMARY_COLOR + ChatColor.BOLD.toString() + CloudInterfaceMode.HOTBAR_ONLY.getDisplay(), Arrays.asList(Main.LIGHT_ACCENT_COLOR + "%divider", Main.LIGHT_ACCENT_COLOR + "Die die Items in deiner", Main.LIGHT_ACCENT_COLOR + "Hotbar einlagern.", Main.LIGHT_ACCENT_COLOR + "%divider"), true, 2)),
