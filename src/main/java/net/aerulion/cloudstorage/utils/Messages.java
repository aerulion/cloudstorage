...
public enum Messages {
    ...
    ERROR_BUYING_CLOUD_EXPERIENCE_TERMINAL(Main.ERROR_COLOR + "Fehler: Das Cloud Experience Terminal konnte nicht gekauft werden. Dein Geld wurde zurückerstattet."),
    ...
    ERROR_MAINTENANCE_MODE(Main.ERROR_COLOR + "Das CloudStorage System befindet sich zur Zeit im Wartungsmodus. Bitte versuche es zu einem späteren Zeitpunkt erneut."),
    ...
    ERROR_WITHDRAWING_EXPERIENCE(Main.ERROR_COLOR + "Fehler: Die Erfahrungspunkte konnten nicht ausgelagert werden. Bitte versuche es später erneut."),
    ...
    MESSAGE_INTERFACE_ITEMS_STORED(Main.PRIMARY_COLOR.toString() + ChatColor.BOLD + "%itemAmount" + Main.LIGHT_ACCENT_COLOR + " Items und " + Main.PRIMARY_COLOR.toString() + ChatColor.BOLD + "%expAmount" + Main.LIGHT_ACCENT_COLOR + " Erfahrungspunkte wurden erfolgreich eingelagert."),
    MESSAGE_INTERFACE_NOTHING_STORED(Main.LIGHT_ACCENT_COLOR + "Es wurden keine Items oder Erfahrungspunkte aus deinem Inventar eingelagert."),
    MESSAGE_INTERFACE_NO_AVAILABLE_EXPERIENCE_TERMINAL(Main.LIGHT_ACCENT_COLOR + "Es wurde kein verfügbares Cloud Experience Terminal gefunden."),
    ...
    MESSAGE_MAINTENANCE_MODE_DISABLED(Main.LIGHT_ACCENT_COLOR + "Der Wartungsmodus wurde deaktiviert."),
    MESSAGE_MAINTENANCE_MODE_ENABLED(Main.LIGHT_ACCENT_COLOR + "Der Wartungsmodus wurde aktiviert."),
