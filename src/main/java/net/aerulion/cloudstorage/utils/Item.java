...
public enum Item {
    ...
    EXPORT_BUS(ItemBuilder.of(SkullUtils.getSkull("https://textures.minecraft.net/texture/480d82ac14229810e9aa32f196f64d6a60597cfc45d5a1702741684c197c1992", UUID.fromString("d3236c55-b190-4b14-8d56-6f0c33d6b6f7"))).withDisplayName(Component.text("Cloud Export Bus").color(Main.PRIMARY_COLOR).decorate(TextDecoration.BOLD).decoration(TextDecoration.ITALIC, TextDecoration.State.FALSE)).build()),
    ...
    GUI_BUTTON_SHOP_CLOUD_EXPERIENCE_TERMINAL(GuiButtonBuilder.of(SkullUtils.getSkull("https://textures.minecraft.net/texture/6a5589702f0d0a8f8aa3e9328b618f02055bf31e5adc625b9adb161a98d70b7f")).withDisplayName(Component.text("Cloud Experience Terminal").color(Main.PRIMARY_COLOR).decorate(TextDecoration.BOLD)).withLore(Messages.DIVIDER.getRaw(), Component.text("Kaufe ein Cloud Experience Terminal").color(Main.LIGHT_ACCENT_COLOR), Component.text("für dein Cloud Netzwerk.").color(Main.LIGHT_ACCENT_COLOR), Messages.DIVIDER.getRaw(), Component.text("Preis:").color(Main.LIGHT_ACCENT_COLOR), Component.text(Messages.decimalFormat.format(Upgrade.EXPERIENCE_TERMINAL_BASE.getPrice()) + " CT").color(Main.PRIMARY_COLOR), Messages.DIVIDER.getRaw()).build()),
    GUI_BUTTON_SHOP_CLOUD_EXPERIENCE_TERMINAL_NO_PERMISSION(GuiButtonBuilder.of(SkullUtils.getSkull("https://textures.minecraft.net/texture/6a5589702f0d0a8f8aa3e9328b618f02055bf31e5adc625b9adb161a98d70b7f")).withDisplayName(Component.text("Cloud Experience Terminal").color(Main.PRIMARY_COLOR).decorate(TextDecoration.BOLD)).withLore(Messages.DIVIDER.getRaw(), Component.text("Kaufe ein Cloud Experience Terminal").color(Main.LIGHT_ACCENT_COLOR), Component.text("für dein Cloud Netzwerk.").color(Main.LIGHT_ACCENT_COLOR), Messages.DIVIDER.getRaw(), Component.text("Du hast nicht die benötigten").color(Main.ERROR_COLOR), Component.text("Rechte, dies zu kaufen.").color(Main.ERROR_COLOR), Messages.DIVIDER.getRaw()).build()),
    GUI_BUTTON_SHOP_CLOUD_EXPORT_BUS(GuiButtonBuilder.of(SkullUtils.getSkull("https://textures.minecraft.net/texture/480d82ac14229810e9aa32f196f64d6a60597cfc45d5a1702741684c197c1992")).withDisplayName(Component.text("Cloud Export Bus").color(Main.PRIMARY_COLOR).decorate(TextDecoration.BOLD)).withLore(Messages.DIVIDER.getRaw(), Component.text("Kaufe ein Cloud Export Bus").color(Main.LIGHT_ACCENT_COLOR), Component.text("für dein Cloud Netzwerk.").color(Main.LIGHT_ACCENT_COLOR), Messages.DIVIDER.getRaw(), Component.text("Preis:").color(Main.LIGHT_ACCENT_COLOR), Component.text("25.000 CT").color(Main.PRIMARY_COLOR), Messages.DIVIDER.getRaw()).build()),
    GUI_BUTTON_SHOP_CLOUD_EXPORT_BUS_NO_PERMISSION(GuiButtonBuilder.of(SkullUtils.getSkull("https://textures.minecraft.net/texture/480d82ac14229810e9aa32f196f64d6a60597cfc45d5a1702741684c197c1992")).withDisplayName(Component.text("Cloud Export Bus").color(Main.PRIMARY_COLOR).decorate(TextDecoration.BOLD)).withLore(Messages.DIVIDER.getRaw(), Component.text("Kaufe ein Cloud Export Bus").color(Main.LIGHT_ACCENT_COLOR), Component.text("für dein Cloud Netzwerk.").color(Main.LIGHT_ACCENT_COLOR), Messages.DIVIDER.getRaw(), Component.text("Du hast nicht die benötigten").color(Main.ERROR_COLOR), Component.text("Rechte, dies zu kaufen.").color(Main.ERROR_COLOR), Messages.DIVIDER.getRaw()).build()),
    GUI_BUTTON_SHOP_CLOUD_IMPORT_BUS(GuiButtonBuilder.of(SkullUtils.getSkull("https://textures.minecraft.net/texture/c2bf7c6eed0026d23349948b47b96cf53d5284c076e7caf8bcba4d5147d35bae")).withDisplayName(Component.text("Cloud Import Bus").color(Main.PRIMARY_COLOR).decorate(TextDecoration.BOLD)).withLore(Messages.DIVIDER.getRaw(), Component.text("Kaufe ein Cloud Import Bus").color(Main.LIGHT_ACCENT_COLOR), Component.text("für dein Cloud Netzwerk.").color(Main.LIGHT_ACCENT_COLOR), Messages.DIVIDER.getRaw(), Component.text("Preis:").color(Main.LIGHT_ACCENT_COLOR), Component.text("25.000 CT").color(Main.PRIMARY_COLOR), Messages.DIVIDER.getRaw()).build()),
    GUI_BUTTON_SHOP_CLOUD_IMPORT_BUS_NO_PERMISSION(GuiButtonBuilder.of(SkullUtils.getSkull("https://textures.minecraft.net/texture/c2bf7c6eed0026d23349948b47b96cf53d5284c076e7caf8bcba4d5147d35bae")).withDisplayName(Component.text("Cloud Import Bus").color(Main.PRIMARY_COLOR).decorate(TextDecoration.BOLD)).withLore(Messages.DIVIDER.getRaw(), Component.text("Kaufe ein Cloud Import Bus").color(Main.LIGHT_ACCENT_COLOR), Component.text("für dein Cloud Netzwerk.").color(Main.LIGHT_ACCENT_COLOR), Messages.DIVIDER.getRaw(), Component.text("Du hast nicht die benötigten").color(Main.ERROR_COLOR), Component.text("Rechte, dies zu kaufen.").color(Main.ERROR_COLOR), Messages.DIVIDER.getRaw()).build()),
    GUI_BUTTON_SHOP_CLOUD_INTERFACE(GuiButtonBuilder.of(SkullUtils.getSkull("https://textures.minecraft.net/texture/d4dff0c31510dc52c21a27b099d0bdf1a9f45c4bb6f8e9c2e98c897f2082d26")).withDisplayName(Component.text("Cloud Interface").color(Main.PRIMARY_COLOR).decorate(TextDecoration.BOLD)).withLore(Messages.DIVIDER.getRaw(), Component.text("Kaufe ein Cloud Interface").color(Main.LIGHT_ACCENT_COLOR), Component.text("für dein Cloud Netzwerk.").color(Main.LIGHT_ACCENT_COLOR), Messages.DIVIDER.getRaw(), Component.text("Preis:").color(Main.LIGHT_ACCENT_COLOR), Component.text("25.000 CT").color(Main.PRIMARY_COLOR), Messages.DIVIDER.getRaw()).build()),
    GUI_BUTTON_SHOP_CLOUD_INTERFACE_NO_PERMISSION(GuiButtonBuilder.of(SkullUtils.getSkull("https://textures.minecraft.net/texture/d4dff0c31510dc52c21a27b099d0bdf1a9f45c4bb6f8e9c2e98c897f2082d26")).withDisplayName(Component.text("Cloud Interface").color(Main.PRIMARY_COLOR).decorate(TextDecoration.BOLD)).withLore(Messages.DIVIDER.getRaw(), Component.text("Kaufe ein Cloud Interface").color(Main.LIGHT_ACCENT_COLOR), Component.text("für dein Cloud Netzwerk.").color(Main.LIGHT_ACCENT_COLOR), Messages.DIVIDER.getRaw(), Component.text("Du hast nicht die benötigten").color(Main.ERROR_COLOR), Component.text("Rechte, dies zu kaufen.").color(Main.ERROR_COLOR), Messages.DIVIDER.getRaw()).build()),
    GUI_BUTTON_SHOP_CLOUD_STORAGE_SLOT(GuiButtonBuilder.of(SkullUtils.getSkull("https://textures.minecraft.net/texture/3e9fc3c04c4d5a2a9291ebaad9fe8f85cb2f7719af8e47475a05405099471b2e")).withDisplayName(Component.text("Cloud Storage Slot").color(Main.PRIMARY_COLOR).decorate(TextDecoration.BOLD)).withLore(Messages.DIVIDER.getRaw(), Component.text("Kaufe einen zusätzlichen Cloud").color(Main.LIGHT_ACCENT_COLOR), Component.text("Storage Slot für dein Cloud").color(Main.LIGHT_ACCENT_COLOR), Component.text("Netzwerk. Der erste Access Point").color(Main.LIGHT_ACCENT_COLOR), Component.text("ist im Preis inbegriffen.").color(Main.LIGHT_ACCENT_COLOR), Messages.DIVIDER.getRaw(), Component.text("Preis:").color(Main.LIGHT_ACCENT_COLOR), Component.text(Messages.decimalFormat.format(Upgrade.CLOUD_STORAGE_SLOT_BASE.getPrice()) + " CT").color(Main.PRIMARY_COLOR), Messages.DIVIDER.getRaw()).build()),
    GUI_BUTTON_SHOP_CLOUD_STORAGE_SLOT_NO_PERMISSION(GuiButtonBuilder.of(SkullUtils.getSkull("https://textures.minecraft.net/texture/3e9fc3c04c4d5a2a9291ebaad9fe8f85cb2f7719af8e47475a05405099471b2e")).withDisplayName(Component.text("Cloud Storage Slot").color(Main.PRIMARY_COLOR).decorate(TextDecoration.BOLD)).withLore(Messages.DIVIDER.getRaw(), Component.text("Kaufe einen zusätzlichen Cloud").color(Main.LIGHT_ACCENT_COLOR), Component.text("Storage Slot für dein Cloud").color(Main.LIGHT_ACCENT_COLOR), Component.text("Netzwerk. Der erste Access Point").color(Main.LIGHT_ACCENT_COLOR), Component.text("ist im Preis inbegriffen.").color(Main.LIGHT_ACCENT_COLOR), Messages.DIVIDER.getRaw(), Component.text("Du hast nicht die benötigten").color(Main.ERROR_COLOR), Component.text("Rechte, dies zu kaufen.").color(Main.ERROR_COLOR), Messages.DIVIDER.getRaw()).build()),
    ...
    GUI_SPACER_IMPORT_BUS(ItemBuilder.of(Material.BLACK_STAINED_GLASS_PANE).withCustomModelData(102).withDisplayName(Component.empty()).build()),
    GUI_SPACER_EXPORT_BUS(ItemBuilder.of(Material.BLACK_STAINED_GLASS_PANE).withCustomModelData(103).withDisplayName(Component.empty()).build()),
    ...
    IMPORT_BUS(ItemBuilder.of(SkullUtils.getSkull("https://textures.minecraft.net/texture/c2bf7c6eed0026d23349948b47b96cf53d5284c076e7caf8bcba4d5147d35bae", UUID.fromString("3d9b6c59-19d2-42ed-96e3-ddd326e0b4c6"))).withDisplayName(Component.text("Cloud Import Bus").color(Main.PRIMARY_COLOR).decorate(TextDecoration.BOLD).decoration(TextDecoration.ITALIC, TextDecoration.State.FALSE)).build()),
    ...
    public static ItemStack getBlockWithMetaData(CloudStorageBlockType cloudStorageBlockType, List<MetaData> metaDataList) {
        ItemStack itemStack = cloudStorageBlockType.getItem().get().clone();
        itemStack = NbtUtils.setNBTString(itemStack, NBT.KEY_CLOUD_STORAGE_BLOCK_TYPE.get(), cloudStorageBlockType.name());
        for (MetaData metaData : metaDataList) {
            itemStack = NbtUtils.setNBTString(itemStack, metaData.getKey(), metaData.getValue());
            if (metaData.getKey().contains("OWNER")) {
                OfflinePlayer offlinePlayer = Bukkit.getOfflinePlayer(UUID.fromString(metaData.getValue()));
                if (offlinePlayer.getName() != null)
                    addLoreMetaData(itemStack, "Eigentümer", offlinePlayer.getName());
            }
        }
        return itemStack;
    }

    private static void addLoreMetaData(ItemStack itemStack, String key, String value) {
        ItemMeta itemMeta = itemStack.getItemMeta();
        List<Component> lore = itemMeta.lore();
        if (lore == null)
            lore = new ArrayList<>();
        lore.add(Component.text(key + ": ")
                .color(Main.LIGHT_ACCENT_COLOR)
    ...
    public static ItemStack getNetworkInfoBook(String ownerUUID) {
        OfflinePlayer offlinePlayer = Bukkit.getOfflinePlayer(UUID.fromString(ownerUUID));
        return GuiButtonBuilder.of(Material.KNOWLEDGE_BOOK).withCustomModelData(1).withDisplayName(Component.text("Cloud Info").color(Main.PRIMARY_COLOR).decorate(TextDecoration.BOLD)).withLore(Component.text("%divider").color(Main.LIGHT_ACCENT_COLOR), Component.text("Netzwerk Eigentümer:").color(Main.LIGHT_ACCENT_COLOR), Component.text(offlinePlayer.getName() == null ? "ERROR" : offlinePlayer.getName()).color(Main.PRIMARY_COLOR), Component.text("%divider").color(Main.LIGHT_ACCENT_COLOR)).build();
    }
}